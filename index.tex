...
\hypersetup{
  ...
  pdfauthor={Daniel Kapitan; Femke Heddema; Julie Fleischer; Chris Ihure; Antragama Abbas; Steven Wanyee; Alessandro Pietrobon; Ryan Chrichton; John Grimes; Mark van der Graaf; Nicole Spieker; Mark de Reuver},
...
\author[6]{Alessandro Pietrobon%
%
}

\author[7]{Ryan Chrichton%
%
}

\author[8]{John Grimes%
%
}
...
\affiliation[7]{organization={Jembi Health
Systems},city={Durban},country={South
Africa},countrysep={,},postcodesep={}}
\affiliation[8]{organization={Australian e-Health Research
...
is not a part of the original OpenHIE and is discussed in the paper.
