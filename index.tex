...
\hypersetup{
  ...
  pdfauthor={Daniel Kapitan; Femke Heddema; Julie Fleischer; Chris Ihure; Steven Wanyee; Alessandro Pietrobon; Ryan Chrichton; John Grimes; Paula van Brakel; Mark van der Graaf; Nicole Spieker; Antragama Abbas; Mark de Reuver},
...
\author[8]{Antragama Abbas%
%
}

\author[8]{Mark de Reuver%
%
}
...
\affiliation[8]{organization={Delft University of
...
``data \& analytics services'' as an additional domain. The rationale
for this addition is to facilitate secondary reuse of health data for
academic research, real-world evidence studies etc. which can be framed
within the context of ongoing efforts towards Findable, Accessible,
...
development projects that aim to establish HDPs in LMICs. The purpose of
this paper, therefore, is to specificy how new standards and
technologies can be integrated into the OpenHIE architecture such that
an open HDP can be realized that supports the following different types
of data sharing.
...
\textbf{?@tbl-types-data-sharing}. First, to investigate the viability
